...
# Анализ результатов
 По результатам приведённым на графиках видно, что применение политик изменения темпа обучения не привелу к значительному улучшению качества, однако ускорило процесс обучения.
